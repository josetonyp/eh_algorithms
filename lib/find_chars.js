module.exports = {
  ...
  // Implementation of a N*N order simple char search algorithm.
  // On each iteration over string 1 chars there is a full search for given char on string 2
  ...
  // The order could be consider 2 N what is converted to N
